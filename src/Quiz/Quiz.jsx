    ...
    >
      ...
      <AnimatePresence mode="wait">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="relative flex justify-between items-center text-lg h-16 m-3">
                  <span className="font-extrabold flex items-center gap-1 text-2xl">
                    <ClockIcon />
                    <span className={`${timeLeft < 6 ? "text-red-600 animate-blink" : "text-black-600"}`}>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {currentQuestion.options.map((option) => {
                    ...
                    let optionStyle = "bg-black border border-gray-300 text-white";
                    if (selectedOption) {
                      if (isCorrect) {
                        optionStyle = "bg-green-500 text-white border-green-600 text-lg font-bold shadow-md";
                      } else if (isSelected) {
                        optionStyle = "bg-red-500 text-white border-red-600";
                      } else {
                        optionStyle = "bg-gray-200 text-gray-700 border-gray-300 text-black";
                      }
                    }
        ...
        {showFinalScore && (
          ...
          >
            <h1 className="text-4xl font-extrabold uppercase">Well Done, Creator!</h1>
            <h2 className="text-4xl font-extrabold uppercase mt-10 mb-10">Your final score is</h2>
